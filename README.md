...
- Gemini 3.1 Flash Image Thinking Mode maps to the real `minimal` / `high` API setting.
- Reference behavior is intentionally simple: first image is the edit target; additional images are prompt-directed references.
